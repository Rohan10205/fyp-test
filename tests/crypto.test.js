...
test("UT-03 getPasswordStrength returns expected score bands", (t) => {
  ...
  t.diagnostic(`weakInput=<redacted>, score=${weakScore}, expected=0`)
  t.diagnostic(`mediumInput=<redacted>, score=${mediumScore}, expected=1`)
  t.diagnostic(`strongInput=<redacted>, score=${strongScore}, expected=4`)
